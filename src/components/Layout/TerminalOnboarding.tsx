    ...
    >
      ...
      <div className="flex justify-center items-center">
        <Terminal>
          ...
          <AnimatedSpan delay={1500}>✔ Connecting to Gelap Privacy Protocol...</AnimatedSpan>
          <AnimatedSpan delay={2000}>✔ Wallet encrypted with zero-knowledge proof</AnimatedSpan>
          <AnimatedSpan delay={2500}>✔ Dark pool initialized</AnimatedSpan>
          <TypingAnimation delay={3000}>&gt; gelap transfer --amount 1.5 ETH --private</TypingAnimation>
          <AnimatedSpan delay={4500}>✔ Generating stealth address...</AnimatedSpan>
          <AnimatedSpan delay={5000}>✔ Transaction obfuscated</AnimatedSpan>
          <AnimatedSpan delay={5500}>✔ Dark transfer complete. Untraceable.</AnimatedSpan>
          <AnimatedSpan delay={6500} className="text-stormy_teal-700 font-semibold">
